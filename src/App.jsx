...
import { Camera, ClipboardList, BarChart3, User, Flame, Target, Zap, UtensilsCrossed, Brain, Droplets, Trophy, Heart, ArrowLeft, Upload, Search, Settings, LogOut, ChevronRight, Lock, Unlock, HelpCircle, Plus, Minus, X, Star, Activity, Scale, Ruler, Calendar } from "lucide-react";
  ...
  return(<div style={{minHeight:"100vh",background:T.bg,fontFamily:"'DM Sans',sans-serif",color:T.text}}>
    ...
    <div style={{padding:"14px 18px 0",background:"linear-gradient(180deg,rgba(14,14,24,0.95),rgba(12,12,19,0.9))",borderBottom:`1px solid ${T.border}`,position:"sticky",top:0,zIndex:10,backdropFilter:"blur(20px)",WebkitBackdropFilter:"blur(20px)"}}>
      <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:12}}>
        ...
        <button onClick={onSignOut} style={{background:"#16162a",border:`1px solid ${T.border}`,color:T.muted,borderRadius:10,padding:"7px 12px",fontSize:11,cursor:"pointer",fontFamily:"inherit",fontWeight:600,transition:"all .2s",flexShrink:0}}><LogOut size={14}/> Out</button>
      </div>
