  ...
  return(<div style={{minHeight:"100vh",background:T.bg,fontFamily:"'DM Sans',sans-serif",color:T.text,transition:"background .3s ease, color .3s ease"}}>
    ...
    <div style={{padding:"14px 18px 0",background:T.headerBg,borderBottom:`1px solid ${T.border}`,position:"sticky",top:0,zIndex:10,backdropFilter:"blur(20px)",WebkitBackdropFilter:"blur(20px)"}}>
      <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:12}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:6,background:"linear-gradient(135deg,#2a1a0a,#1a0f05)",border:`1px solid ${T.orange}35`,borderRadius:24,padding:"5px 12px",boxShadow:`0 0 16px ${T.orange}15`,flexShrink:0}}><Flame size={14}/><span className="bounce-pop" style={{fontSize:13,fontWeight:900,color:T.orange}}>{stats.streak}d</span></div>
    ...
    <div style={{padding:"24px 18px 18px",background:T.bg}}>
      <div style={{display:"flex",alignItems:"center",gap:20}}>
        ...
        <div style={{flex:1,display:"flex",flexDirection:"column",gap:6}}>
          {[["Eaten",consumed,T.accent,<UtensilsCrossed size={12}/>],["Remaining",Math.max(rem,0),T.blue,<Target size={12}/>],["Goal",goal,T.orange,<Zap size={12}/>]].map(([l,v,c,ic])=>(<div key={l} style={{display:"flex",alignItems:"center",gap:8,background:l==="Goal"?"#1a1208":`${c}08`,border:`1px solid ${l==="Goal"?T.orange+"40":c+"18"}`,borderRadius:12,padding:"7px 10px"}}>
            <span>{ic}</span>
            <div style={{flex:1}}>
