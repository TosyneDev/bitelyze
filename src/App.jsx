...
function TrackerApp({profile,goal,uid,onEditProfile,onSignOut}){
  ...
  const placeholders=["Try: Jollof rice with chicken...","Try: Big Mac meal...","Try: Greek salad with feta...","Try: Pounded yam and egusi...","Try: Avocado toast with eggs..."];
      ...
      {tab==="analyze"&&(<>
        ...
        {showClarifier&&(<>
          ...
          <div style={{position:"fixed",bottom:0,left:0,right:0,background:T.card,borderRadius:"24px 24px 0 0",padding:"28px 22px 36px",zIndex:51,animation:"slideUp .4s cubic-bezier(0.34,1.56,0.64,1)",border:`1px solid ${T.border}`,maxHeight:"70vh",overflowY:"auto"}}>
            ...
            <input value={customPortion} onChange={e=>{setCustomPortion(e.target.value);setSelectedPortion(null);}} placeholder="Or describe it... e.g. '1.5 cups'" style={{width:"100%",padding:"12px 16px",background:"#0e0e16",border:`1.5px solid ${T.border}`,borderRadius:12,color:T.text,fontSize:14,outline:"none",fontFamily:"inherit",marginBottom:16}}/>
