      ...
      {tab==="analyze"&&(<>
        ...
        {result&&!loading&&!parseError&&(<div className="fadeUp" style={{marginTop:18}}>
          ...
          <Card style={{textAlign:"center",padding:"20px",position:"relative",overflow:"hidden"}}>
            ...
            {(result.confidence==="medium"||result.confidence==="low")&&result.confidenceNote&&(<p style={{fontSize:11,color:"#a0a0c0",lineHeight:1.5,marginTop:8,position:"relative",padding:"0 8px",display:"inline-flex",alignItems:"center",gap:6,justifyContent:"center"}}><Info size={12}/> {result.confidenceNote}</p>)}
